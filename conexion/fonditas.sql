...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-02-2022 a las 00:02:33
...
(6, 'Fonda JC', 'Miguel Hidalgo', '1', '2', 54710, 'Huilango', 'Cuautitlán Izcalli', 'Cuautitlán Izcalli', 'Estado de México', 'México', '2022-02-22');
...
INSERT INTO `platillos` (`idplatillo`, `nombre`, `descripcion`, `ingredientes`, `costo`, `idfonda`, `fecha_creacion`) VALUES
(1, 'Enchiladas Verdes', 'Enchiladas con pollo en salsa verde con crema y queso panela.', 'Queso, tomate, agua, ajo, cebolla, tortillas, crema, pechuga de pollo, sal.', 48, 1, '2022-02-15'),
(2, 'Prueba', 'Descripción de prueba', 'Prueba de ingredientes', 60, 4, '2022-02-15'),
(3, 'chilaquiles', 'kjdkls, dkdfjslkd, djshdkjdm, dsjdfjhdjk, kjljkj', 'skdkjdhds dfsmdnfsmdfsmn dshkjdshkjdf', 120, 3, '2022-02-22');
...
--
ALTER TABLE `fondas`
  MODIFY `idfonda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
